...
const Profile = () => {
  ...
  return (
    <>
      <Helmet>
        <title> Profile - Globe Trekker</title>
        <meta
          name="description"
          content="Manage your Globe Trekker profile, view saved destinations, favorite stories, and customize your travel preferences."
        />
        <meta
          name="keywords"
          content="Globe Trekker profile, user dashboard, travel favorites, saved destinations, travel account"
        />
        <meta name="author" content="Globe Trekker Team" />

        {/* Open Graph / Facebook */}
        <meta property="og:title" content="Your Profile - Globe Trekker" />
        <meta
          property="og:description"
          content="Access your Trip Tales profile to manage your travel experiences, saved places, and favorite stories."
        />
        <meta property="og:type" content="profile" />
        <meta property="og:url" content="https://globetrekker.site/profile" />
        <meta
          property="og:image"
        ...
        <meta name="twitter:title" content="Your Profile - Globe Trekker" />
        <meta
        ...
        <div className="md:w-[80%] w-full">
          <div className="relative mb-8 ">
            ...
            <div className="relative p-6">
              <h1 className="text-3xl max-sm:text-xl font-bold text-emerald-800 mb-2">
                Welcome, Fellow Traveler!
              </h1>
              <p className="text-emerald-600  max-sm:text-sm">
